...
public class HttpRequestHandlerV3 implements Runnable {
    ...
    private void process() {
        try (socket;
            ...
            String requestString = requertToString(reader);
    ...
    private static String requertToString(BufferedReader reader) throws IOException {
